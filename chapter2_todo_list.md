...
| 序号 | 编号 | 类型 | 内容 | 所在节 | 状态 |
|-----|------|-----|------|-------|------|
| 1 | 公式 (2.1-1) | 公式 | OFI 定义公式 | 第一节 三、Cont随机订单簿模型与OFI定义 | ⬜ 待完成 |
| 2 | 公式 (2.1-2) | 公式 | OFI线性价格冲击模型 | 第一节 三、Cont随机订单簿模型与OFI定义 | ⬜ 待完成 |
| 3 | 公式 (2.2-1) | 公式 | 多档OFI深度衰减加权定义 | 第二节 一、从单档到多档：OFI的深度扩展方法 | ⬜ 待完成 |
| 4 | 公式 (2.2-2) | 公式 | 综合OFI（Integrated OFI）的PCA构造方法 | 第二节 一、从单档到多档：OFI的深度扩展方法 | ⬜ 待完成 |
| 5 | 公式 (2.2-3) | 公式 | 基于撤单率修正的有效OFI定义 | 第二节 二、从总量到质量：订单流毒性与虚假流动性识别 | ⬜ 待完成 |
