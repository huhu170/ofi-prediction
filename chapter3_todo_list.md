...
| 2 | 公式 (3.1-1) | 公式 | 时间窗口内OFI的聚合定义 | 二、数据清洗与特征描述采样 | ⬜ 待完成 |
| 3 | 公式 (3.1-2) | 公式 | 零均值标准化公式 | 二、数据清洗与特征描述采样 | ⬜ 待完成 |
| 4 | 图 3.1-1 | 图片 | 滑动窗口采样示意图 | 二、数据清洗与特征描述采样 | ⬜ 待完成 |
| 5 | 公式 (3.1-3) | 公式 | 三分类标签定义 | 二、数据清洗与特征描述采样 | ⬜ 待完成 |
| 6 | 公式 (3.1-4) | 公式 | 交易方向识别规则 | 三、数据对齐方法 | ⬜ 待完成 |

### 第二节 指数与代表性个股的动态协方差分析（7项）

| 序号 | 编号 | 类型 | 内容 | 所在小节 | 状态 |
|-----|------|-----|------|---------|------|
| 7 | 公式 (3.2-1) | 公式 | 滚动窗口协方差估计 | 一、方法概述 | ⬜ 待完成 |
| 8 | 公式 (3.2-2) | 公式 | 中间价收益率定义 | 二、数据选择与预处理 | ⬜ 待完成 |
| 9 | 公式 (3.2-3) | 公式 | 滚动窗口协方差估计公式 | 三、协方差计算与个股筛选 | ⬜ 待完成 |
| 10 | 公式 (3.2-4) | 公式 | 滚动相关系数计算 | 三、协方差计算与个股筛选 | ⬜ 待完成 |
...
| 22 | 公式 (3.4-1) | 公式 | 协方差加权损失函数 | 三、训练策略 | ⬜ 待完成 |
